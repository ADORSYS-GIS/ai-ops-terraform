...
| <a name="module_ai_gateway_crds"></a> [ai\_gateway\_crds](#module\_ai\_gateway\_crds) | terraform-module/release/helm | >= 2.9.1 |
...
| <a name="input_kube_token"></a> [kube\_token](#input\_kube\_token) | Path to the kubeconfig file | `string` | `""` | no |
